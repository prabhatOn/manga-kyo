...
export const LanguageHub: React.FC<LanguageHubProps> = ({
  ...
  return (
    <section className="bg-[var(--ink-surface)] border-b border-[var(--ink-border)] py-10 sm:py-16 px-4 sm:px-8 lg:px-12 relative overflow-hidden transition-colors duration-400">
      {/* Subtle Screentone Pattern */}
      <div className="absolute inset-0 bg-screentone-dots opacity-15 pointer-events-none" />

      <div className="max-w-7xl mx-auto relative z-10">
        {/* Header Block */}
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 sm:gap-6 mb-6 sm:mb-10 pb-4 sm:pb-6 border-b border-[var(--ink-border)]">
          <div>
            ...
            <h2 className="font-editorial text-2xl sm:text-3xl md:text-4xl font-extrabold text-white tracking-tight">
              THE HINDI MANGA SANCTUARY <span className="font-hindi text-base sm:text-xl font-bold text-gray-400 block sm:inline mt-1 sm:mt-0">| हिंदी मंगा संग्रह</span>
            </h2>
          ...
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 sm:px-5 py-2.5 sm:py-3 bg-[#181622] hover:bg-[#221f2f] text-white border border-[#2e2a3c] font-tech text-xs font-bold rounded-xs transition-colors shrink-0"
          >
